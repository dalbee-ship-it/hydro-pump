      ...
      <div className="max-w-md mx-auto px-4 py-10">
        ...
        <form onSubmit={handleSubmit} className="bg-gray-900 border border-gray-800 rounded-xl p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm text-white h-20 resize-none focus:outline-none focus:border-cyan-500 transition-colors"
